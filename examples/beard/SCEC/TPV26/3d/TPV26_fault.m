...
sim_name = 'TPV26_base_';

names = {[sim_name,'faultst-050dp000'],...
         [sim_name,'faultst150dp000' ],...
         [sim_name,'faultst-050dp050'],...
         [sim_name,'faultst150dp050' ],...
         [sim_name,'faultst-150dp100'],...
         [sim_name,'faultst-050dp100'],...
         [sim_name,'faultst000dp100' ],...
         [sim_name,'faultst050dp100' ],...
         [sim_name,'faultst100dp100' ],...
         [sim_name,'faultst150dp100' ],...
         [sim_name,'faultst-050dp150'],...
         [sim_name,'faultst150dp150' ]};
