...
fault_stations = {
  ...
  "faultst-050dp050", -5.0,  5.0, interp_fault(fault, -5.0,  5.0), 0.0, 0.0, 1.0, 0.1,
  "faultst150dp050" , 15.0,  5.0, interp_fault(fault, 15.0,  5.0), 0.0, 0.0, 1.0, 0.1,
  "faultst-150dp100",-15.0, 10.0, interp_fault(fault,-15.0, 10.0), 0.0, 0.0, 1.0, 0.1,
  "faultst-050dp100", -5.0, 10.0, interp_fault(fault, -5.0, 10.0), 0.0, 0.0, 1.0, 0.1,
  "faultst000dp100" ,  0.0, 10.0, interp_fault(fault,  0.0, 10.0), 0.0, 0.0, 1.0, 0.1,
  "faultst050dp100" ,  5.0, 10.0, interp_fault(fault,  5.0, 10.0), 0.0, 0.0, 1.0, 0.1,
  "faultst100dp100" , 10.0, 10.0, interp_fault(fault, 10.0, 10.0), 0.0, 0.0, 1.0, 0.1,
  "faultst150dp100" , 15.0, 10.0, interp_fault(fault, 15.0, 10.0), 0.0, 0.0, 1.0, 0.1,
  "faultst-050dp150", -5.0, 15.0, interp_fault(fault, -5.0, 15.0), 0.0, 0.0, 1.0, 0.1,
  "faultst150dp150" , 15.0, 15.0, interp_fault(fault, 15.0, 15.0), 0.0, 0.0, 1.0, 0.1,
}
