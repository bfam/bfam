...
#define X(order) \
  ...
  void beard_dgx_scale_rates_slip_weakening_##order(int N,         \
  ...
  void beard_dgx_add_rates_slip_weakening_##order(int N,           \
      bfam_subdomain_dgx_quad_glue_t *sub,                         \
...
void beard_dgx_scale_rates_elastic_(int N,
    bfam_subdomain_dgx_quad_t *sub, const char *rate_prefix,
    const bfam_long_real_t a);
void beard_dgx_scale_rates_slip_weakening_(int N,
    bfam_subdomain_dgx_quad_glue_t *sub, const char *rate_prefix,
    const bfam_long_real_t a);
void beard_dgx_add_rates_elastic_(int N,
    ...
    const char *field_prefix_rhs, const char *rate_prefix,
    const bfam_long_real_t a);
void beard_dgx_add_rates_slip_weakening_(int N,
    bfam_subdomain_dgx_quad_glue_t *sub, const char *field_prefix_lhs,
    const char *field_prefix_rhs, const char *rate_prefix,
    const bfam_long_real_t a);
