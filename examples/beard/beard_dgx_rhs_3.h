...
#define X(order)                                                     \
  ...
  void beard_dgx_intra_rhs_sponge_3_##order(int N,                   \
      bfam_subdomain_dgx_t *sub, const char *rate_prefix,            \
      const char *field_prefix, const bfam_long_real_t t);           \
  void beard_dgx_rupture_time_3_##order(int N,                       \
  ...
  void beard_dgx_scale_rates_interface_3_##order(int N,              \
      bfam_subdomain_dgx_t *sub, const char *rate_prefix,            \
  ...
  void beard_dgx_add_rates_elastic_3_##order(int N,                  \
      ...
      const bfam_long_real_t a);                                     \
  void beard_dgx_add_rates_interface_3_##order(int N,                \
      bfam_subdomain_dgx_t *sub, const char *field_prefix_lhs,       \
      const char *field_prefix_rhs, const char *rate_prefix,         \
      const bfam_long_real_t a, const char **f_names);               \
  ...
  void beard_dgx_inter_rhs_ageing_law_interface_3_##order(int N,     \
      bfam_subdomain_dgx_t *sub, const char *rate_prefix,            \
      const char *minus_rate_prefix, const char *field_prefix,       \
      const bfam_long_real_t t);                                     \
...
void beard_dgx_intra_rhs_elastic_3_(int N,
    bfam_subdomain_dgx_t *sub, const char *rate_prefix,
    const char *field_prefix, const bfam_long_real_t t);
void beard_dgx_intra_rhs_sponge_3_(int N,
    bfam_subdomain_dgx_t *sub, const char *rate_prefix,
    const char *field_prefix, const bfam_long_real_t t);
...
void beard_dgx_scale_rates_elastic_3_(int N,
    bfam_subdomain_dgx_t *sub, const char *rate_prefix,
    const bfam_long_real_t a);
void beard_dgx_scale_rates_interface_3_(int N,
    bfam_subdomain_dgx_t *sub, const char *rate_prefix,
    const bfam_long_real_t a, const char **f_names);
...
void beard_dgx_add_rates_elastic_3_(int N,
    ...
    const char *field_prefix_rhs, const char *rate_prefix,
    const bfam_long_real_t a);
void beard_dgx_add_rates_interface_3_(int N,
    bfam_subdomain_dgx_t *sub, const char *field_prefix_lhs,
    const char *field_prefix_rhs, const char *rate_prefix,
    const bfam_long_real_t a, const char **f_names);
void beard_dgx_add_rates_glue_p_3_(int N,
    bfam_subdomain_dgx_t *sub, const char *field_prefix_lhs,
    const char *field_prefix_rhs, const char *rate_prefix,
    const bfam_long_real_t a,
    const char** scals, const char** vects, const char** tens);
