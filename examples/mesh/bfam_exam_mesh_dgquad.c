...
static void zero_field(bfam_locidx_t npoints, const char *name,
...
static void x2_field(bfam_locidx_t npoints, const char *name, bfam_real_t time,
...
static void y2_field(bfam_locidx_t npoints, const char *name, bfam_real_t time,
                     bfam_real_t *restrict x, bfam_real_t *restrict y,
                     bfam_real_t *restrict z, struct bfam_subdomain *s,
                     void *arg, bfam_real_t *restrict field)
{
...
static void z2_field(bfam_locidx_t npoints, const char *name, bfam_real_t time,
                     bfam_real_t *restrict x, bfam_real_t *restrict y,
                     bfam_real_t *restrict z, struct bfam_subdomain *s,
                     void *arg, bfam_real_t *restrict field)
{
...
static void build_mesh(MPI_Comm mpicomm)
{
  int rank;
  ...
  bfam_vtk_write_file((bfam_domain_t *)domain, BFAM_DOMAIN_AND, volume, NULL,
                      "bfam_mesh", 0, NULL, NULL, NULL, 1, 1, 0);
  ...
  bfam_communicator_t *communicator = bfam_communicator_new(
      (bfam_domain_t *)domain, BFAM_DOMAIN_AND, tags, mpicomm, 10, 0, NULL);
