 ...
 *
 */
static void bfam_domain_add_minus_field(bfam_domain_t *thisDomain,
                                        bfam_domain_match_t match,
 ...
 *
 */
static void bfam_domain_add_minus_fields_critbit(bfam_domain_t *thisDomain,
                                                 bfam_domain_match_t match,
 ...
 *
 */
static void bfam_domain_add_minus_field_critbit(bfam_domain_t *thisDomain,
                                                bfam_domain_match_t match,
                                                bfam_critbit0_tree_t *tags,
                                                const char *field)
{
 ...
 *
 */
static void bfam_domain_add_plus_fields(bfam_domain_t *thisDomain,
                                        bfam_domain_match_t match,
 ...
 *
 */
static void bfam_domain_add_plus_field(bfam_domain_t *thisDomain,
                                       bfam_domain_match_t match,
                                       const char **tags, const char *field)
{
  const char *fields[] = {field, NULL};
 ...
 *
 */
static void bfam_domain_add_plus_fields_critbit(bfam_domain_t *thisDomain,
                                                bfam_domain_match_t match,
                                                bfam_critbit0_tree_t *tags,
                                                const char **fields)
{
 ...
 *
 */
static void bfam_domain_add_plus_field_critbit(bfam_domain_t *thisDomain,
                                               bfam_domain_match_t match,
                                               bfam_critbit0_tree_t *tags,
                                               const char *field)
{
 ...
 *
 */
static void bfam_domain_init_field(bfam_domain_t *thisDomain,
                                   bfam_domain_match_t match, const char **tags,
...
#if 0
static void bfam_domain_init_fields_critbit(bfam_domain_t *thisDomain,
                                     bfam_domain_match_t match,
                                     bfam_critbit0_tree_t *tags,
                                     const char *field, bfam_real_t time,
                                     bfam_subdomain_init_field_t init_field,
 ...
 */
static void bfam_communicator_start(bfam_communicator_t *comm)
{
 ...
 * \param [in,out] communicator communicator
 */
static void bfam_communicator_finish(bfam_communicator_t *comm)
{
 ...
 */
static void bfam_domain_pxest_init(bfam_domain_pxest_t *domain, MPI_Comm domComm,
                            p4est_connectivity_t *conn)
{
 ...
 */
static bfam_domain_pxest_t *bfam_domain_pxest_new(MPI_Comm domComm,
                                           p4est_connectivity_t *conn)
{
  bfam_domain_pxest_t *newDomain = bfam_malloc(sizeof(bfam_domain_pxest_t));
...
static void bfam_domain_pxest_create_mesh(bfam_domain_pxest_t *domain,
 ...
 */
static void bfam_domain_pxest_adapt(bfam_domain_pxest_t *domain,
...
#if 0
static void bfam_subdomain_dgx_interpolate_data(const bfam_real_t *src, int8_t c_src,
                                         int N_src, bfam_real_t *dst,
                                         int8_t c_dst, int N_dst, uint8_t flags,
                                         bfam_dictionary_t *N2N,
                                         const int inDIM)
{
...
#if 0
static bfam_real_t point_interp(bfam_subdomain_dgx_point_interp_t *point,
                                bfam_real_t *source, const int inDIM)
{
...
#if 0
static bfam_real_t bfam_subdomain_dgx_point_interp_field_m(
    ...
    const char *field, const int inDIM)
{
  ...
  return point_interp(point, source, inDIM);
}
#endif

#if 0
static bfam_real_t
bfam_subdomain_dgx_point_interp_field(bfam_subdomain_dgx_point_interp_t *point,
...
#if 0
static void bfam_subdomain_dgx_point_interp_fields(
    ...
    const char **fields, const int inDIM)
{
  ...
  {
    const bfam_real_t v =
        bfam_subdomain_dgx_point_interp_field(point, prefix, fields[n], inDIM);
...
#if 0
static void bfam_subdomain_dgx_point_interp_open(
 ...
 *
 */
static void bfam_subdomain_dgx_point_interp_init(
    ...
    const int filename_size, const int inDIM)
{
  ...
  point->num_interp = inDIM;
  point->interp = bfam_malloc_aligned(inDIM * sizeof(bfam_real_t *));
 ...
 *
 */
static bfam_subdomain_dgx_point_interp_t *bfam_subdomain_dgx_point_interp_new(
    ...
    const char *filename, const int filename_size, const int inDIM)
{
  ...
  bfam_subdomain_dgx_point_interp_init(point, sub, elem, r, filename,
                                       filename_size, inDIM);
...
#if 0
static void bfam_subdomain_dgx_add_rates_glue_p(
...
{
  BFAM_ABORT_IF(num_Vi != inDIM && !(J == NULL && ni == NULL && sJ == NULL),
 ...
 * \param [in]     dim       number of (computational) dimensions
 */
static void bfam_subdomain_dgx_init_grid(
  ...
  if (inDIM > 0)
  {
    ...
    for (bfam_locidx_t k = 0; k < K; ++k)
    {
      ...
      if (inDIM == 1)
        ...
        BFAM_ABORT("not setup of dim = %d", inDIM);
    }
    ...
    bfam_long_real_t **lJrx =
        bfam_malloc_aligned(num_Vi * inDIM * sizeof(bfam_long_real_t *));
    for (int n = 0; n < num_Vi * inDIM; n++)
      ...
      for (int v = 0; v < num_Vi; v++)
      {
        for (int d = 0; d < inDIM; d++)
        {
          ...
          bfam_real_t *restrict xr =
              bfam_dictionary_get_value_ptr(&subdomain->base.fields, name);
          for (int n = 0; n < K * Np; ++n)
            xr[n] = (bfam_real_t)lJrx[d + v * inDIM][n];
        }
      }
      BFAM_ASSERT(lni == NULL && lsJ == NULL);
    }
 ...
 *
 */
static void bfam_vtk_write_struc_file(bfam_domain_t *domain, bfam_domain_match_t match,
...
#if 0
static void bfam_util_mvmult(size_t m, size_t n, bfam_long_real_t *restrict A,
 ...
 */
static int bfam_subdomain_delete_tag(bfam_subdomain_t *thisSubdomain, const char *tag)
{
 ...
 */
static int bfam_subdomain_has_tag_prefix(bfam_subdomain_t *thisSubdomain,
                                  const char *tag)
{
  int found = 0;
 ...
 *
 */
static void bfam_subdomain_minus_add_tag(bfam_subdomain_t *thisSubdomain,
                                  const char *tag)
{
 ...
 * \returns It returns 1 if the tag was removed, 0 otherwise.
 */
static int bfam_subdomain_minus_delete_tag(bfam_subdomain_t *thisSubdomain,
                                    const char *tag)
{
  BFAM_ASSERT(thisSubdomain->glue_m);
 ...
 * \return nonzero iff \a thisSubdomain has the tag \a tag
 */
static int bfam_subdomain_minus_has_tag(bfam_subdomain_t *thisSubdomain,
                                 const char *tag)
{
  BFAM_ASSERT(thisSubdomain->glue_m);
 ...
 * \return nonzero iff \a thisSubdomain has the tag \a tag
 */
static int bfam_subdomain_minus_has_tag_prefix(bfam_subdomain_t *thisSubdomain,
                                        const char *tag)
{
  BFAM_ASSERT(thisSubdomain->glue_m);
  int found = 0;
 ...
 *
 */
static void bfam_subdomain_plus_add_tag(bfam_subdomain_t *thisSubdomain,
                                 const char *tag)
{
 ...
 * \returns It returns 1 if the tag was removed, 0 otherwise.
 */
static int bfam_subdomain_plus_delete_tag(bfam_subdomain_t *thisSubdomain,
                                   const char *tag)
{
  BFAM_ASSERT(thisSubdomain->glue_p);
 ...
 * \return nonzero iff \a thisSubdomain has the tag \a tag
 */
static int bfam_subdomain_plus_has_tag(bfam_subdomain_t *thisSubdomain,
                                const char *tag)
{
  BFAM_ASSERT(thisSubdomain->glue_p);
 ...
 * \return nonzero iff \a thisSubdomain has the tag \a tag
 */
static int bfam_subdomain_plus_has_tag_prefix(bfam_subdomain_t *thisSubdomain,
                                       const char *tag)
{
  BFAM_ASSERT(thisSubdomain->glue_p);
  int found = 0;
 ...
 *            2 &if {\it name} {\rm was added successfully}}$.
 */
static int bfam_subdomain_field_plus_add(bfam_subdomain_t *thisSubdomain,
                                  const char *name)
{
 ...
 *            2 &if {\it name} {\rm was added successfully}}$.
 */
static int bfam_subdomain_field_minus_add(bfam_subdomain_t *thisSubdomain,
                                   const char *name)
{
 ...
 *            2 &if {\it name} {\rm was added successfully}}$.
 */
static int bfam_subdomain_field_face_add(bfam_subdomain_t *thisSubdomain,
                                  const char *name)
{
 ...
 */
static void bfam_subdomain_field_init(bfam_subdomain_t *thisSubdomain,
 ...
 */
static bfam_domain_t *bfam_domain_new(MPI_Comm domComm)
{
 ...
 *
 */
static void bfam_domain_get_subdomains_critbit(bfam_domain_t *thisDomain,
                                               bfam_domain_match_t matchType,
                                               bfam_critbit0_tree_t *tags,
 ...
 *
 */
static void bfam_domain_add_field(bfam_domain_t *thisDomain,
                                  bfam_domain_match_t match, const char **tags,
                                  const char *field)
{
  const char *fields[] = {field, NULL};
 ...
 *
 */
static void bfam_domain_add_fields_critbit(bfam_domain_t *thisDomain,
                                           bfam_domain_match_t match,
                                           bfam_critbit0_tree_t *tags,
                                           const char **fields)
{
 ...
 *
 */
static void bfam_domain_add_field_critbit(bfam_domain_t *thisDomain,
                                          bfam_domain_match_t match,
                                          bfam_critbit0_tree_t *tags,
                                          const char *field)
{
 ...
 *
 */
static void bfam_domain_add_minus_fields(bfam_domain_t *thisDomain,
                                         bfam_domain_match_t match,
                                         const char **tags, const char **fields)
{
  bfam_subdomain_t **subdomains =
...
#if 0
size_t bfam_gopt_arg(const void *vptr_opts, int key, const char **arg)
{
  const opt_t *opts = vptr_opts;
  size_t count = 0;
...
#if 0
const char *bfam_gopt_arg_i(const void *vptr_opts, int key, size_t i)
{
  const opt_t *opts = vptr_opts;
...
#if 0
size_t bfam_gopt_args(const void *vptr_opts, int key, const char **args,
                      size_t args_len)
{
  ...
  for (; opts->key; ++opts)
    if (opts->key == key)
    {
      if (args_stop == args_ptr)
        return args_len + bfam_gopt(opts, key);
 ...
 *
 */
static void bfam_subdomain_dgx_point_interp_free(
    bfam_subdomain_dgx_point_interp_t *point)
{
  point->sub = NULL;
  point->elem = -1;
