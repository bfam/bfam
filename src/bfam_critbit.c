...
int
bfam_critbit0_contains(bfam_critbit0_tree_t *t, const char *u)
{
...
int
bfam_critbit0_insert(bfam_critbit0_tree_t *t, const char *u)
{
...
int
bfam_critbit0_delete(bfam_critbit0_tree_t*t,const char*u)
{
  const uint8_t *ubytes = (void*)u;
  const size_t ulen = strlen(u);
  uint8_t *p = t->root;
...
void
bfam_critbit0_clear(bfam_critbit0_tree_t*t)
{
...
int
bfam_critbit0_allprefixed(bfam_critbit0_tree_t *t, const char *prefix,
