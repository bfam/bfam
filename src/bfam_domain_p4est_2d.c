...
bfam_domain_p4est_2d_t*
bfam_domain_p4est_2d_new(MPI_Comm domComm,
                      p4est_connectivity_t *conn)
{
  bfam_domain_p4est_2d_t* newDomain = bfam_malloc(sizeof(bfam_domain_p4est_2d_t));
  bfam_domain_p4est_2d_init(newDomain,domComm,conn);
  return newDomain;
}

void
bfam_domain_p4est_2d_init(bfam_domain_p4est_2d_t *domain, MPI_Comm domComm,
                       p4est_connectivity_t *conn)
{
...
void
bfam_domain_p4est_2d_free(bfam_domain_p4est_2d_t *domain)
{
...
bfam_domain_p4est_2d_num_parallel_faces(p4est_mesh_t *mesh)
{
 ...
 * and \c bfam_domain_p4est_2d_face_recv_cmp comparison
 * functions.
 *
 ...
 */
static void
bfam_domain_p4est_2d_parallel_face_mapping(p4est_mesh_t *mesh,
 ...
 */
static bfam_locidx_t
bfam_domain_p4est_2d_parallel_face_num_neighbors(bfam_locidx_t numParallelFaces,
 ...
 */
static void
bfam_domain_p4est_2d_num_neighbor_faces(bfam_locidx_t numParallelFaces,
 ...
 */
static void
bfam_domain_p4est_2d_parallel_face_send_recv(MPI_Comm comm,
    bfam_locidx_t numParallelFaces, bfam_subdomain_face_map_entry_t *mapping,
 ...
 */
static void
bfam_domain_p4est_2d_parallel_face_mapping_check(MPI_Comm comm,
    bfam_locidx_t numParallelFaces, bfam_subdomain_face_map_entry_t *mapping,
    bfam_locidx_t numNeighbors, bfam_locidx_t *numNeighborFaces,
    bfam_locidx_t *neighborRank)
{
  ...
  bfam_domain_p4est_2d_parallel_face_send_recv(comm, numParallelFaces, mapping,
 ...
 */
static void
bfam_domain_p4est_2d_fill_ghost_subdomain_ids(MPI_Comm comm,
    bfam_locidx_t numParallelFaces, bfam_subdomain_face_map_entry_t *mapping,
    bfam_locidx_t numNeighbors, bfam_locidx_t *numNeighborFaces,
 ...
 */
static bfam_locidx_t
bfam_domain_p4est_2d_num_inter_subdomain_faces(p4est_mesh_t *mesh,
 ...
 */
static void
bfam_domain_p4est_2d_inter_subdomain_face_mapping(bfam_locidx_t rank,
 ...
 */
static bfam_locidx_t
bfam_domain_p4est_2d_num_boundary_faces(p4est_mesh_t *mesh)
{
  const p4est_locidx_t K = mesh->local_num_quadrants;
 ...
 */
static void
bfam_domain_p4est_2d_boundary_subdomain_face_mapping(p4est_mesh_t *mesh,
...
void
bfam_domain_p4est_2d_split_dgx_subdomains(bfam_domain_p4est_2d_t *domain,
    bfam_locidx_t numSubdomains, bfam_locidx_t *subdomainID, int *N)
{
  ...
  bfam_locidx_t numParallelFaces = bfam_domain_p4est_2d_num_parallel_faces(mesh);

  bfam_subdomain_face_map_entry_t *pfmapping
    = bfam_malloc_aligned(numParallelFaces*
        sizeof(bfam_subdomain_face_map_entry_t));

  bfam_domain_p4est_2d_parallel_face_mapping(mesh, numParallelFaces, pfmapping);

  bfam_locidx_t numNeighbors =
    bfam_domain_p4est_2d_parallel_face_num_neighbors(numParallelFaces, pfmapping);
  ...
  bfam_domain_p4est_2d_num_neighbor_faces(numParallelFaces, pfmapping,
      numNeighbors, numNeighborFaces, neighborRank);

#ifdef BFAM_DEBUG
  bfam_domain_p4est_2d_parallel_face_mapping_check(p4est->mpicomm,
      numParallelFaces, pfmapping, numNeighbors, numNeighborFaces,
      neighborRank);
#endif

  bfam_domain_p4est_2d_fill_ghost_subdomain_ids(p4est->mpicomm, numParallelFaces,
      pfmapping, numNeighbors, numNeighborFaces, neighborRank, subdomainID, N,
      ghostSubdomainID, ghostN);

  bfam_locidx_t numInterSubdomainFaces =
    bfam_domain_p4est_2d_num_inter_subdomain_faces(mesh, subdomainID);
  ...
  bfam_domain_p4est_2d_inter_subdomain_face_mapping(rank, mesh, subdomainID,
      numInterSubdomainFaces, ifmapping);


  bfam_locidx_t numBoundaryFaces =
    bfam_domain_p4est_2d_num_boundary_faces(mesh);
  ...
  bfam_domain_p4est_2d_boundary_subdomain_face_mapping(mesh, subdomainID,
  ...
  for(bfam_locidx_t id = 0; id < numSubdomains; ++id)
  {
    ...
    snprintf(name[id], BFAM_BUFSIZ, "dgx_2d_%05jd", (intmax_t) id);
  ...
  for(bfam_locidx_t id = 0; id < numSubdomains; ++id)
  {
    const bfam_long_real_t *V[] = {VX,VY};
    subdomains[id] =
      bfam_subdomain_dgx_new_2(id,
                             name[id],
                             N[id],
                             Nv,
                             2,
  ...
  for(bfam_locidx_t ifk = 0; ifk < numInterSubdomainFaces; )
  {
    ...
    for(int r = 0; r <= repeat; ++r)
    {
      ...
      snprintf(glueName, BFAM_BUFSIZ, "dgx_2d_glue_%d_%05jd_%05jd_%05jd",
      ...
      snprintf(glue_num_tag,BFAM_BUFSIZ,"_glue_%d",id_m);
