...
void bilinear_test()
{
  ...
  bfam_real_t x[(N[0] + 1) * (N[1] + 1) * (N[2] + 1)];
  bfam_real_t y[(N[0] + 1) * (N[1] + 1) * (N[2] + 1)];
  bfam_real_t z[(N[0] + 1) * (N[1] + 1) * (N[2] + 1)];
  ...
  BFAM_ABORT_IF_NOT(fabs(x[N[0] / 2 + N[1] / 2 * (N[0] + 1)]) < 1e-15 &&
                        fabs(y[N[0] / 2 + N[1] / 2 * (N[0] + 1)]) < 1e-15,
                    "2-D interp fail");

  bfam_util_linear_blend(x, y, z, 3, N, NULL, NULL, xc, yc, zc);
  BFAM_ABORT_IF_NOT(
      fabs(x[N[0] / 2 + (N[1] / 2 + N[2] / 2 * (N[1] + 1)) * (N[0] + 1)]) <
              1e-15 &&
          fabs(y[N[0] / 2 + (N[1] / 2 + N[2] / 2 * (N[1] + 1)) * (N[0] + 1)]) <
              1e-15 &&
          fabs(z[N[0] / 2 + (N[1] / 2 + N[2] / 2 * (N[1] + 1)) * (N[0] + 1)]) <
              1e-15,
      "3-D interp fail");

  bfam_locidx_t Nl[3] = {6, 2, 10};
  bfam_gloidx_t gx[3] = {19, 11, 9};
  bfam_real_t xl[(Nl[0] + 1) * (Nl[1] + 1) * (Nl[2] + 1)];
  bfam_real_t yl[(Nl[0] + 1) * (Nl[1] + 1) * (Nl[2] + 1)];
  bfam_real_t zl[(Nl[0] + 1) * (Nl[1] + 1) * (Nl[2] + 1)];
  ...
  BFAM_ABORT_IF_NOT(
      fabs(
          xl[Nl[0] / 2 + (Nl[1] / 2 + Nl[2] / 2 * (Nl[1] + 1)) * (Nl[0] + 1)]) <
              1e-15 &&
          fabs(yl[Nl[0] / 2 +
                  (Nl[1] / 2 + Nl[2] / 2 * (Nl[1] + 1)) * (Nl[0] + 1)]) <
              1e-15 &&
          fabs(zl[Nl[0] / 2 +
                  (Nl[1] / 2 + Nl[2] / 2 * (Nl[1] + 1)) * (Nl[0] + 1)]) < 1e-15,
      "3-D interp fail");
}
