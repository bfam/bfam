...
main (int argc, char *argv[])
{
  ...
  bfam_subdomain_dgx_t *d1 =
    bfam_subdomain_dgx_new_1(2, "dim1", 8, 1, 1, NULL, 1, NULL, NULL, NULL, 1);
  bfam_subdomain_dgx_t *d2 =
    bfam_subdomain_dgx_new_2(3, "dim2", 6, 1, 1, NULL, 1, NULL, NULL, NULL, 2);
  bfam_subdomain_dgx_t *d3 =
    bfam_subdomain_dgx_new_3(5, "dim3", 4, 1, 1, NULL, 1, NULL, NULL, NULL, 3);
