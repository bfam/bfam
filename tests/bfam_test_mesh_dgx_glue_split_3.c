...
static int build_state(MPI_Comm mpicomm, state_t *state)
{
  int failures = 0;
  int rank;
  ...
  bfam_domain_pxest_quad_to_glueid_3(domain->pxest, tree_to_glueid, glueID);
  ...
  const char *comm_args_scalars[] = {"_grid_x0", "_grid_x1", "_grid_x2", NULL};
  ...
  bfam_vtk_write_file(d, BFAM_DOMAIN_OR, volume, NULL, "volume", 0, NULL, NULL,
                      NULL, 0, 0, 0);

  const char *glue_id_0[] = {"_glue_id_0", NULL};

  bfam_vtk_write_file(d, BFAM_DOMAIN_OR, glue_id_0, NULL, "glue_id", 0, NULL,
                      NULL, NULL, 0, 0, 0);
...
static int free_state(MPI_Comm mpicomm, state_t *state)
{
  int failures = 0;
...
static int check_vmaps(bfam_subdomain_dgx_t *sub, const char *name)
{
  ...
  BFAM_ABORT_IF(f == NULL, "subdomain %s: doesn't have a field %s",
                sub->base.name, name);
...
static int test_conn(MPI_Comm mpicomm, state_t *state)
{
  int failures = 0;
  bfam_domain_pxest_t_3 *domain = state->domain;
  ...
  const char *comm_args_face_scalars[] = {"_grid_nx0", "_grid_nx1", "_grid_nx2",
                                          NULL};
  const char *comm_args_scalars[] = {"p1", "p2", "p3", "p4", "p5", "p6", NULL};
  const char *comm_args_vectors[] = {"v", "u", NULL};
  const char *comm_args_vector_components[] = {"p3", "p1", "p2", "p4",
                                               "p5", "p6", NULL};
  const char *comm_args_tensors[] = {"T", "S", NULL};
  const char *comm_args_tensor_components[] = {"p3", "p2", "p1", "p6", "p4",
                                               "p5", "p2", "p3", "p1", "p5",
                                               "p4", "p6", NULL};
  commargs.scalars_m = comm_args_scalars;
  commargs.scalars_p = comm_args_scalars;
...

  {
    ...
    for (bfam_locidx_t i = 0; i < numSubdomains; ++i)
    {
      ...
      bfam_real_t *restrict p1 =
          bfam_dictionary_get_value_ptr(&s->fields, "p1");
      bfam_real_t *restrict p2 =
          bfam_dictionary_get_value_ptr(&s->fields, "p2");
      bfam_real_t *restrict p3 =
          bfam_dictionary_get_value_ptr(&s->fields, "p3");
      bfam_real_t *restrict p4 =
          bfam_dictionary_get_value_ptr(&s->fields, "p4");
      bfam_real_t *restrict p5 =
          bfam_dictionary_get_value_ptr(&s->fields, "p5");
      bfam_real_t *restrict p6 =
          bfam_dictionary_get_value_ptr(&s->fields, "p6");

      bfam_real_t *restrict p1_m =
          bfam_dictionary_get_value_ptr(&s->glue_m->fields, "p1");
      bfam_real_t *restrict p2_m =
          bfam_dictionary_get_value_ptr(&s->glue_m->fields, "p2");
      bfam_real_t *restrict p3_m =
          bfam_dictionary_get_value_ptr(&s->glue_m->fields, "p3");
      bfam_real_t *restrict p4_m =
          bfam_dictionary_get_value_ptr(&s->glue_m->fields, "p4");
      bfam_real_t *restrict p5_m =
          bfam_dictionary_get_value_ptr(&s->glue_m->fields, "p5");
      bfam_real_t *restrict p6_m =
          bfam_dictionary_get_value_ptr(&s->glue_m->fields, "p6");

      bfam_real_t *restrict p1_p =
          bfam_dictionary_get_value_ptr(&s->glue_p->fields, "p1");
      bfam_real_t *restrict p2_p =
          bfam_dictionary_get_value_ptr(&s->glue_p->fields, "p2");
      bfam_real_t *restrict p3_p =
          bfam_dictionary_get_value_ptr(&s->glue_p->fields, "p3");
      bfam_real_t *restrict p4_p =
          bfam_dictionary_get_value_ptr(&s->glue_p->fields, "p4");
      bfam_real_t *restrict p5_p =
          bfam_dictionary_get_value_ptr(&s->glue_p->fields, "p5");
      bfam_real_t *restrict p6_p =
          bfam_dictionary_get_value_ptr(&s->glue_p->fields, "p6");
  ...
  bfam_vtk_write_file((bfam_domain_t *)domain, BFAM_DOMAIN_OR, glue_id_0, NULL,
